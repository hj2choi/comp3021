...
public class NoteBookWindow extends Application {
	...
	private HBox addHBox() {
		...
		buttonSearch.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				List<Note> list = noteBook.searchNotes(currentSearch);
				ArrayList<Note> noteList = new ArrayList<Note>(list);
	...
	private VBox addVBox() {
		...
		titleslistView.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<Object>() {
			...
			public void changed(ObservableValue ov, Object t, Object t1) {
				...
				ArrayList<Note> noteTitle = new ArrayList<>();
				for (Folder f : noteBook.getFolders()) {
					if (f.getName().equals(currentFolder)) {
						noteTitle.addAll(f.getNotes());
					}
				}

				for (Note n : noteTitle) {
	...
	private void updateListView(ArrayList<Note> noteList) {
